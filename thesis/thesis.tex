...
\thesisTitle{MajorMatch: From Program Embeddings to a Deployed Major Recommendation System}
...
\thesisMonth{May}
\thesisYear{2026}
\thesisAdvisor{Professor Sidi Lu} % Advisor name with title

% Enter Degree, e.g. Master of Science or Master of Arts or Doctor of Philosophy.
%\thesisType{Honors Thesis}
...
\thesisHometown{Williamsburg, Virginia}
...
\thesisDegreeOne{Bachelor of Science, William \& Mary, 2026}
...
\thesisCommittee[Computer Science]{Professor Sidi Lu}{William \& Mary}  % use {College of William \& Mary} -- Shanhe
\thesisCommittee[Computer Science]{Professor Adwait Nadkarni}{William \& Mary}
\thesisCommittee[Economics]{Professor Nathaniel Throckmorton}{William \& Mary}
...
%\makeThesisBib{Reference/thesis}
...
\input{Content/03_Embeddings}
\input{Content/04_MajorMatch}
\input{Content/05_Conclusion}

\appendix
\input{Content/AppendixA}

\bibliographystyle{Reference/wmbib}   
